...
class IngestionHelper:
    ...
    def transform_file_into_documents(
        file_name: str, reader: BaseReader, file_data: Path
    ) -> list[Document]:
        documents = IngestionHelper._load_file_to_documents(file_name, reader, file_data)
    ...
    @staticmethod
    def _load_file_to_documents(file_name: str, reader: BaseReader, file_data: Path) -> list[Document]:
