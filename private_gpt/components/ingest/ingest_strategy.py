...
class IngestionStrategyRegistry:
     ...
     def __init__(self) -> None:
          self.strategies: list[IngestionStrategy] = []
          self.default: IngestionStrategy | None = None
     ...
     def get_strategy(self, file_name: str) -> IngestionStrategy:
          ...
          registered = {ext for s in self.strategies for ext in s.supported_extensions()}
          raise ValueError(
